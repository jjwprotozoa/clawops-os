...
Provide trusted, decision-grade intelligence across products: metrics
definitions, reporting, anomaly detection specs, and executive summaries.

## Scope

- Metrics registry: canonical definitions for MRR, churn, activation, LTV, and
  pipeline stages.
- Reporting: weekly/monthly scorecards, narrative summaries, variance analysis
  (draft).
